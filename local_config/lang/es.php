...
$Text['ti_order'] = "Hacer el pedido para el";
...
$Text['unit of half kilo'] = 'Medio kilo' ;
$Text['mililiters'] = 'Milímetros' ;
$Text['liter'] = 'Litros';
$Text['one liter"'] = 'Litros enteros';
$Text['quarter of a liter'] = 'Cuartos de litro';
$Text['half a liter'] = 'Medio litro';
...
$Text['revisar_comandes'] = "Comprobación de pedidos";
$Text['revisar_cistelles'] = "Distribución en cestas";
...
$Text['transport_label'] = "Transporte";
$Text['transport_fee_type'] = "Tipo de distribución";
$Text['transport'] = "Coste del transporte"; //product type
...
$Text['msg_err_deactivate_prdrow'] = "No se puede desactivar este producto porque se ha incluido en pedidos para varias fechas. Primero debes desactivar el producto para cada fecha.";
$Text['msg_err_deactivate_ir'] = "No se pueden desactivar varias fechas para este producto porque en algunas fechas hay productos pedidos. Puedes desactivar la opción Repetir directamente o desactivar los productos o fechas uno a uno.";

$Text['dozen'] = "Docena";

$Text['caltrans'] = "Calcula el transporte";
