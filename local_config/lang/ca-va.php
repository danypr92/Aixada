...
$Text['search'] = "Cerca";
$Text['id'] = "id";
$Text['uf_short'] = "Cistella";
$Text['uf_long'] = "Cistella";
...
$Text['sel_uf'] = "Seleccioneu una cistella...";
$Text['sel_uf_or_account'] = "Seleccioneu cistella o compte...";
...
$Text['head_ti_manage'] = "Gestió";
$Text['head_ti_manage_uf'] = "Unitats familiars/Membres";
$Text['head_ti_incidents'] = "Incidències";
 ...
 */
$Text['ti_mng_activate_products'] = "Les cistelles podran demanar els següents productes PER EL dia ";
...
//$Text['ti_mng_ufs'] = "Gestiona les cistelles";
...
$Text['ti_report_incidents'] = "Incidències d'avui";
$Text['ti_incidents'] = "Incidències";
$Text['ti_validate'] = "Valida la compra de la cistella";
...
$Text['ti_all_sales'] = "Totes les compres anteriors de la cistella";
...
$Text['Econo-Legal Commission'] = 'Comissió econòmica';
$Text['Logistic Commission'] = 'Comissió de proveïdors';
...
$Text['create_uf'] = "Nova cistella";
$Text['name_person'] = "Nom";
$Text['address'] = "Adreça";
$Text['zip'] = "CP";
$Text['city'] = "Localitat";
$Text['phone1'] = "Telèfon 1";
$Text['phone2'] = "Telèfon 2";
$Text['email'] = "Correu-e";
$Text['web'] = "URL";
...
$Text['edit_uf'] = "Edita cistella";
//$Text['members_uf'] = "Membres de la cistella";
$Text['mentor_uf'] = "Cistella amfitriona";
...
$Text['deposit_by_uf'] = 'Ingrés per la cistella';
$Text['deposit_other'] = 'Altres tipus de ingressos...';
$Text['make_deposit_4HU'] = 'Ingrés de la cistella';
...
$Text['get_cart_4_uf'] = "Recupera la compra de la cistella";
$Text['make_deposit'] = "Ingrés de la cistella";
$Text['success_deposit'] = "L'ingrés s'ha fet correctament";
$Text['amount'] = "Quantitat";
$Text['comment'] = "Comentari";
//$Text['deposit_other_uf'] = "Fes un ingrés per a una altra cistella o compte";
...
$Text['msg_err_noUfAssignedYet'] = "Encara no estàs assignat a cap cistella. Si us plau, demana a algú que et registri.";


//$Text['msg_reg_success'] = "Us heu registrat correctament, però el vostre usuari encara no s'ha aprovat. Registreu la resta de membres de la vostra cistella i contacteu amb un responsable per finalitzar el registre.";
...
$Text['nav_report_timelines_uf'] = "Per cistelles";
...
$Text['nav_report_incidents'] = "Incidències d'avui";
$Text['nav_report_shop_hu'] = "Per cistella";
$Text['nav_report_shop_pv'] = "Per Proveïdor";

$Text['nav_incidents'] = "Incidències";
...
$Text['btn_new_incident'] = "Incidència nova";
$Text['btn_reset_pwd'] = "Restableix contrasenya"; 
 ...
 * Incidents
 */
$Text['create_incident'] = "Crea una incidència";
$Text['overview'] = "Resum";
...
//$Text['msg_err_select_uf'] = "Per assignar un membre nou a una cistella primer heu de seleccionar la cistella fent-hi clic! Si voleu crear una cistella nova, feu-ho fent clic en + Nova cistella.";
//$Text['msg_err_select_non_member'] = "Per assignar un membre nou a una cistella, primer heu de seleccionar-lo de la llista de no membres que hi ha a la dreta!"; 
...
$Text['msg_please_set_ufid_deposit'] = "No s'ha definit l'ID de la cistella. Heu de triar una cistella o seleccionar una altra cistella per fer el dipòsit!";
...
$Text['msg_select_cart_first'] = "Per afegir articles per validar abans heu de seleccionar una cistella o una cistella!";
...
$Text['msg_delete_incident'] = "Segur que voleu eliminar aquesta incidència?";
//$Text['msg_err_selectFirstUF'] = "No hi ha cistella seleccionada. Selecciona una primer i després les seves compres."; //ADDED JAN 2012
...
$Text['responsible_uf'] = 'Cistella responsable';
...
$Text['nothing_to_val'] = "Res a validar per a la cistella";
$Text['cart_id'] = "Id cistella";
$Text['msg_several_carts'] = "La cistella seleccionada té més d'una cistella pendent de validar. Tria'n una si us plau:";
$Text['transfer_type'] = "Tipus";
$Text['todays_carts'] = "Cistelles d'avui";
$Text['head_ti_torn'] = "Resum del torn"; 
$Text['btn_validate'] = "Validar";
$Text['desc_validate'] = "Validar cistelles actuals i antigues de les cistelles. Ingressar efectiu.";
...
$Text['desc_stats'] = "Descarrega un informe resumit del torn actual, incloent-hi incidències, cistelles en negatiu, despesa total i productes amb estoc negatiu";
...
$Text['filter_uf'] = "Filtra per cistella";
$Text['purchase_uf'] = "Compra de la cistella";
$Text['quantity_short'] = "Qu";
$Text['incl_iva'] = "incl. IVA";
$Text['incl_revtax'] = "incl. ImpRev";
$Text['no_news_today'] = "Cap notícia és la millor notícia: avui no hi ha hagut incidències!";
...
$Text['active_changed_uf'] = "Estat actiu de la cistella modificat";
$Text['msg_err_mentoruf'] = "La cistella no pot amfitriona de sí mateixa!";
$Text['msg_err_ufexists'] = "Ja existeix aquest nom de cistella. Tria'n un altre si us plau!";
$Text['msg_err_form_init'] = "Sembla que el formulari per a crear noves cistelles no s'ha inicialitzat correctament. Torna a carregar la pàgina... ";
...
$Text['ti_add_member'] = "Afegir nou membre a la cistella";
...
$Text['withdraw_uf'] = "Retirar diners de compte cistella"; 
$Text['withdraw_cuota'] = "Retirar quota de membre";
$Text['msg_err_noorder'] = "No s'ha trobat cap producte per el període seleccionat!";
$Text['revisar_comandes'] = "Revisió de comandes";
$Text['revisar_cistelles'] = "Distribució de cistelles";
...
$Text['msg_err_no_deposit'] = "La darrera cistella no ha realitzat cap dipòsit???!!!";
$Text['btn_load_cart'] = "Continua amb la següent cistella";
...
$Text['msg_incident_emailed'] = "L'incidència s'ha enviat correctament!";
...
$Text['active_ufs'] = "Només cistelles actives";
...
$Text['withdraw_banc'] = "Retirar del compte de consum";
$Text['deposit_sales_cash'] = "Dipòsit en efectiu de vendes";
$Text['ti_stock_report'] = "Informe d'estoc per "; 
$Text['netto_stock'] = "Valor net d'estoc"; 
$Text['brutto_stock'] = "Valor brut d'estoc"; 
$Text['total_netto_stock'] = "Valor net total d'estoc"; 
$Text['total_brutto_stock'] = "Valor brut total d'estoc"; 
$Text['sales_total_pv'] = "Vendes totals per al proveïdor ";
$Text['dates_breakdown'] = "Desglossament de dates"; 
$Text['price_brutto'] = "Preu brut"; 
$Text['total_brutto'] = "Brut total";
$Text['total_netto'] = "Net total";
$Text['msg_err_oldPwdWrong'] = "Ho sentim, però la contrasenya antiga no és correcta. Torneu-ho de nou. "; 
$Text['msg_err_adminStuff'] = "Privilegis d'accés insuficients. Només l'administrador pot fer això!";
