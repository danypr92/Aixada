...
class canned_table_manager {
 ...
 case 'aixada_cart':
     return "['id','Nom','TRANSLATION(uf)','Data de compra','TRANSLATION(operator_id)','Validada','TRANSLATION(ts_last_saved)']";

 case 'aixada_currency':
     return "['id','Nom','TRANSLATION(one_euro)']";

 case 'aixada_fee_type':
 ...
 case 'aixada_iva_type':
     return "['id','Nom','Percentatge','Descripci\u00f3']";

 case 'aixada_member':
     return "['id','Ref. personalitzada','TRANSLATION(uf)','Nom','Adre\u00e7a','NIF','CP','Localitat','Tel\u00e8fon1','Tel\u00e8fon2','URL','Banc o Caixa','Compte bancari','Imatge','Observacions','Actiu','Participant','Adult','TRANSLATION(ts)']";

 case 'aixada_order':
     return "['id','Prove\u00efdor','Data d_entrega','TRANSLATION(ts_sent_off)','TRANSLATION(date_received)','Data de compra','Total','Observacions','TRANSLATION(revision_status)','Refer\u00e8ncia d_entrega','Refer\u00e8ncia de pagament']";

 case 'aixada_order_item':
     return "['id','TRANSLATION(uf)','TRANSLATION(favorite_cart)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','Data d_entrega','TRANSLATION(product)','Quantitat','TRANSLATION(ts_ordered)']";

 case 'aixada_order_to_shop':
     return "['TRANSLATION(order_item_id)','TRANSLATION(uf)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','TRANSLATION(product)','Quantitat','arribat','TRANSLATION(revised)','TRANSLATION(aixada_order_to_shop_ibfk_1)','TRANSLATION(aixada_order_to_shop_ibfk_2)','TRANSLATION(aixada_order_to_shop_ibfk_3)']";
 ...
 case 'aixada_product':
     return "['id','Prove\u00efdor','Nom','Descripci\u00f3','Codi de barres','Id extern','Actiu','Unitat familiar responsable','Tipus de producte','TRANSLATION(order_min_quantity)','Categoria','Tipus d_impost revolucionari','Percentatge d_IVA','Preu per unitat','Unitat de comanda','Unitat de venda','Quantitat m\u00ednima per tindre en estoc','Quantitat actual en estoc','Difer\u00e8ncia amb l_estoc m\u00ednim','URL de descripci\u00f3','Imatge','TRANSLATION(ts)']";

 case 'aixada_product_category':
     return "['id','Descripci\u00f3']";

 case 'aixada_product_orderable_for_date':
     return "['id','TRANSLATION(product)','Data d_entrega','TRANSLATION(closing_date)']";

 case 'aixada_provider':
     return "['id','Nom','Contacte','Adre\u00e7a','NIF','CP','Localitat','Tel\u00e8fon1','Tel\u00e8fon2','Fax','Correu-e','URL','Banc o Caixa','Compte bancari','Imatge','Observacions','Actiu','Distribuci\u00f3 del coste','Unitat familiar responsable','Temps de proc\u00e9s','TRANSLATION(ts)']";

 case 'aixada_rev_tax_type':
     return "['id','Nom','Descripci\u00f3','TRANSLATION(rev_tax_percent)']";
 ...
 case 'aixada_unit_measure':
     return "['id','Nom','Unitat']";

 case 'aixada_user':
     return "['id','Inici de sessi\u00f3','TRANSLATION(password)','Correu-e','TRANSLATION(uf)','Membre','Prove\u00efdor','TRANSLATION(language)','TRANSLATION(gui_theme)','TRANSLATION(last_login_attempt)','TRANSLATION(last_successful_login)','TRANSLATION(created_on)']";
 ...
 case 'aixada_provider':
     return "[transport_fee_type_id,responsible_uf_id]";
