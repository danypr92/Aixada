...
class canned_table_manager {
 ...
 case 'aixada_order_item':
     return "['id','TRANSLATION(uf)','TRANSLATION(favorite_cart)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','Fecha de entrega','TRANSLATION(product)','Cantidad','TRANSLATION(ts_ordered)']";
 ...
 case 'aixada_product_orderable_for_date':
     return "['id','TRANSLATION(product)','Fecha de entrega','TRANSLATION(closing_date)']";

 case 'aixada_provider':
     return "['id','Nombre','Contacto','Direcci\u00f3n','NIF','CP','Localidad','Tel\u00e9fono1','Tel\u00e9fono2','Fax','Correo electr\u00f3nico','URL','Banco o Caja','Cuenta bancario','Imagen','Observaciones','Activo','Tipo de distribuci\u00f3n','Unidad familiar responsable','Tiempo de procesamiento','TRANSLATION(ts)']";
 ...
 case 'aixada_product_orderable_for_date':
     return "[{name:'id',index:'id',label:'id',width:'150',xmlmap:'id',editable:false,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'product_id',index:'product',label:'TRANSLATION(product_id)',width:'300',xmlmap:'product',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true},edittype:'select',editoptions:{dataUrl:'php\/ctrl\/SmallQ.php?oper=getFieldOptions&table=aixada_product&field1=id&field2=name'}},{name:'date_for_order',index:'date_for_order',label:'Fecha de entrega',width:'300',xmlmap:'date_for_order',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true}},{name:'closing_date',index:'closing_date',label:'TRANSLATION(closing_date)',width:'300',xmlmap:'closing_date',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true}}]";
