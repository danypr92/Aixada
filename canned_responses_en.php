...
class canned_table_manager {
 ...
 case 'aixada_order_item':
     return "['id','TRANSLATION(uf)','TRANSLATION(favorite_cart)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','Delivery date','TRANSLATION(product)','Quantity','TRANSLATION(ts_ordered)']";
 ...
 case 'aixada_product_orderable_for_date':
     return "['id','TRANSLATION(product)','Delivery date','TRANSLATION(closing_date)']";

 case 'aixada_provider':
     return "['id','Name','Contact','Address','VAT Reg No','Zip','City','Phone1','Phone2','Fax','Email','Web','Bank','Bank account','Picture','Notes','Active','Distribution type','Responsible household','Processing time','TRANSLATION(ts)']";
 ...
 case 'aixada_product_orderable_for_date':
     return "[{name:'id',index:'id',label:'id',width:'150',xmlmap:'id',editable:false,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'product_id',index:'product',label:'TRANSLATION(product_id)',width:'300',xmlmap:'product',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true},edittype:'select',editoptions:{dataUrl:'php\/ctrl\/SmallQ.php?oper=getFieldOptions&table=aixada_product&field1=id&field2=name'}},{name:'date_for_order',index:'date_for_order',label:'Delivery date',width:'300',xmlmap:'date_for_order',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true}},{name:'closing_date',index:'closing_date',label:'TRANSLATION(closing_date)',width:'300',xmlmap:'closing_date',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true}}]";
